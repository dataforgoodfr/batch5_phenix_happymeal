...
def main():
    ...
    test_result = {
           ...
           "meal_completion": [{'nb_meals': 1, 'meal_price': 5.970000000000001, 'categ_bought': ['Viande, poisson, oeufs', 'Produits gras sucrés salés', 'Matières grasses ajoutées', 'Produits laitiers', 'Féculents']},
                               {'nb_meals': 8, 'meal_price': 11.94, 'categ_bought': ['Viande, poisson, oeufs', 'Produits gras sucrés salés', 'Matières grasses ajoutées', 'Produits laitiers', 'Féculents']}]
            }
